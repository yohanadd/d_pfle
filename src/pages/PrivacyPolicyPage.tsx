      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto">
            ...
            <Card className="mb-12 border-trust-green/20 shadow-lg">
              <CardHeader className="bg-gradient-to-r from-trust-green/5 to-trust-green/10">
                <CardTitle className="text-2xl font-bold text-gray-900 flex items-center">
                  <Shield className="w-6 h-6 mr-3 text-trust-green" />
              ...
              <CardContent className="p-6 space-y-6">
                <div>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-start space-x-3 p-4 bg-gray-50 rounded-lg">
                      ...
                      <div>
                        <h4 className="font-semibold text-gray-900">Verantwortliche Personen:</h4>
                        <p className="text-gray-700">Magdalena Glowa</p>
                        <p className="text-gray-700">Puneet Kaur Parmar</p>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-4">
                    <h3 className="text-lg font-semibold text-gray-900">Anschrift:</h3>
                    
                    <div className="flex items-start space-x-3">
                      <MapPin className="w-5 h-5 text-trust-green mt-1" />
                      <div>
            ...
            <Card className="mb-8 border-trust-green/20 shadow-lg">
              <CardHeader className="bg-gradient-to-r from-trust-green/5 to-trust-green/10">
              ...
              <Card className="border-trust-green/20 shadow-lg">
                ...
                <CardContent className="p-6">
                  <div className="text-gray-700 leading-relaxed space-y-6">
                    ...
                    <div className="space-y-4">
                      <div>
                        <h4 className="font-semibold text-gray-900 mb-2">9.1 Widerruf von erteilten Einwilligungen</h4>
                        <p>
                      ...
                      <div>
                        <h4 className="font-semibold text-gray-900 mb-2">9.2 Bestätigung und Auskunft</h4>
                        <p>
                      ...
                      <div>
                        <h4 className="font-semibold text-gray-900 mb-2">9.3 Berichtigung und Löschung</h4>
                        <p>
                      ...
                      <div>
                        <h4 className="font-semibold text-gray-900 mb-2">9.4 Einschränkung der Verarbeitung</h4>
                        <p>
                      ...
                      <div>
                        <h4 className="font-semibold text-gray-900 mb-2">9.5 Widerspruch</h4>
                        <p>
                      ...
                      <div>
                        <h4 className="font-semibold text-gray-900 mb-2">9.6 Herausgabe der Daten und Datenübertragbarkeit</h4>
                        <p>
              ...
              <Card className="border-trust-green/20 shadow-lg">
                ...
                <CardContent className="p-6">
                  <div className="text-gray-700 leading-relaxed">
                    ...
                    <p className="mt-4 font-semibold">Stand: Januar 2020</p>
                  </div>
                </CardContent>
              </Card>
            </div>
